...
class HandlebarsParserSuite extends munit.FunSuite {
  ...
  //   assertEquals(result, model.Text(source).asRight[Parser.Error], s"Cannot parse \"$source\"")
  // }
  ...
  //   assertEquals(
  //     result,
  //     ("", model.Expression.Value.String("foo bar")).asRight[Parser.Error],
  ...
  //   assertEquals(result, ("", model.Expression.Value.Boolean(true)).asRight[Parser.Error], s"Cannot parse \"$source\"")
  // }
  ...
  //   assertEquals(result, ("", model.Expression.Value.Boolean(false)).asRight[Parser.Error], s"Cannot parse \"$source\"")
  // }
  ...
  //   assertEquals(result, ("", model.Expression.Value.Number(5)).asRight[Parser.Error], s"Cannot parse \"$source\"")
  // }
  ...
  //   assertEquals(result, ("", model.Expression.Value.Number(5.2)).asRight[Parser.Error], s"Cannot parse \"$source\"")
  // }
  ...
  // //   assertEquals(
  // //     clue(result),
  // //     ("", "foo" -> model.Expression.Value.String("bar")).asRight[Parser.Error]
  // //   )
  // // }
  ...
  // //   assertEquals(
  // //     clue(result),
  // //     ("", "foo" -> model.Expression.Value.Number(5)).asRight[Parser.Error]
  // //   )
  // // }
  ...
  // //   assertEquals(
  // //     clue(result),
  // //     ("", Map("foo" -> model.Expression.Value.String("bar"), "bar" -> model.Expression.Value.Boolean(true)))
  ...
  // //         model.Expression.Value.Number(5),
  ...
  // //   assertEquals(
  // //     clue(result),
  // //     (" ", List.empty[model.Expression]).asRight[Parser.Error]
  // //   )
  // // }
  ...
  //   val expectedResult = model.Expression.Function(
  //     "helper",
  //     List.empty,
  //     Map.empty
  //   )
  ...
  //     ),
  //     Map(
  //       "foo" -> model.Expression.Value.Number(5)
  //     )
  //   )
  //   assertEquals(
  //     result,
  ...
  //     "helper",
  //     List.empty,
  //     Map("foo" -> model.Expression.Value.Number(5))
  //   )
  //   assertEquals(
  //     result,
  //     ("", expectedResult).asRight[Parser.Error],
  ...
  //       model.Expression.Value.Number(5),
  //       model.Expression.Value.Boolean(false),
  //       model.Expression.Value.Number(8)
  //     ),
  //     Map(
  //       "foo" -> model.Expression.Value.Boolean(true),
  //       "bar" -> model.Expression.Value.String("baz")
  //     )
  //   )
  //   assertEquals(
  //     result,
  ...
  //   val expectedResult = model.Expression.Function(
  //     "helper",
  //     List(model.Expression.Value.Number(5)),
  //     Map.empty
  //   )
  //   assertEquals(
  //     result,
  ...
  //     List(
  //       model.Expression.Value.String("foo"),
  //       model.Expression.Value.Number(5.6)
  //     ),
  //     Map(
  //       "argName1" -> model.Expression.Value.Boolean(true),
  //       "argName2" -> model.Expression.Value.Boolean(false)
  //     )
  //   )
  //   assertEquals(
  //     result,
  ...
  //     "helper",
  //     List(
  //       model.Expression.Value.Number(6)
  //     ),
  //     Map(
  //       "one" -> model.Expression.Function(
  //         "helper",
  //         List(
  //           model.Expression.Value.Number(5)
  //         ),
  ...
  //             ),
  //             Map(
  //               "one" -> model.Expression.Value.Number(1)
  //             )
  //           )
  //         )
  //       )
  ...
  //         ),
  //         Map(
  //           "two" -> model.Expression.Value.Number(2)
  //         )
  //       )
  //     )
  //   )
  ...
  //   val expectedResult = model.Expression.Function("this")
  ...
  //         "lookup",
  //         List(
  //           model.Expression.Function("this"),
  //           model.Expression.Value.String("foo")
  //         )
  //       ),
  ...
  //         )
  //       ),
  //       model.Expression.Value.String("bar baz")
  //     )
  //   )
  ...
  //               "render",
  //               List(
  //                 model.Expression.Value.String("luna")
  //               )
  //             )
  //           )
  //         )
  ...
  //               "render",
  //               List(
  //                 model.Expression.Value.String(" and ")
  //               )
  //             ),
  //             model.Expression.Function(
  //               "render",
  ...
  //   assertEquals(clue(result), model.Comment("foo bar").asRight[Parser.Error])
  // }
  ...
  //   assertEquals(clue(result), model.Comment("foo bar", eatSpace = model.EatSpace.Left).asRight[Parser.Error])
  // }
  ...
  //   assertEquals(clue(result), model.Comment("foo bar", eatSpace = model.EatSpace.Right).asRight[Parser.Error])
  // }
  ...
  //   assertEquals(clue(result), model.Comment("foo bar", eatSpace = model.EatSpace.Both).asRight[Parser.Error])
  // }
}
